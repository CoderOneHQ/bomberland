...
| `type`           | `a` &#124; `b` &#124; `x` &#124; `bp` &#124; `m` &#124; `o` &#124; `w` | <ul><li>`a`: ammunition</li><li>`b`: Bomb</li><li>`x`: Blast</li><li>`bp`: Blast Powerup</li><li>`m`: Metal Block</li><li>`o`: Ore Block</li><li>`w`: Wooden Block</li> |
...
| `AMMO_SPAWN_WEIGHTING=0.9`                             | If a spawn appears, weighting % that it will be an ammunition (versus a powerup). <br> `AMMO_SPAWN_WEIGHTING + BLAST_POWERUP_SPAWN_WEIGHTING = 1`               |
...
| `BLAST_POWERUP_SPAWN_WEIGHTING=0.1`                    | If a spawn appears, weighting % that it will be a powerup (versus an ammunition). <br> `AMMO_SPAWN_WEIGHTING + BLAST_POWERUP_SPAWN_WEIGHTING = 1`               |
...
| `ENTITY_SPAWN_PROBABILITY_PER_TICK=0.025`              | Probability of a spawn appearing somewhere on the map each tick                                                                                                 |
| `FIRE_SPAWN_INTERVAL_TICKS=2`                          | Number of ticks between each single tile of fire spawned                                                                                                        |
| `GAME_DURATION_TICKS=300`                              | Number of ticks before ring of fire spawns                                                                                                                      |
| `GAME_START_DELAY_MS=2000`                             | Time (ms) before game server starts after both agents connect                                                                                                   |
| `INITIAL_AMMUNITION=3`                                 | Starting number of ammunition                                                                                                                                   |
...
| `SYMMETRICAL_MAP_ENABLED=1`                            | Disable/enable symmetrical map generation (on vertical axis)                                                                                                    |
| `MAP_HEIGHT=15`                                        | Size of map (y-axis)                                                                                                                                            |
| `MAP_WIDTH=15`                                         | Size of map (x-axis)                                                                                                                                            |
| `ORE_BLOCK_FREQUENCY=0.0617`                           | Controls the number of ore blocks in the world                                                                                                                  |
...
| `STEEL_BLOCK_FREQUENCY=0.222`                          | Controls number of steel blocks in map                                                                                                                          |
...
| `WOOD_BLOCK_FREQUENCY=0.246`                           | Controls number of wooden blocks in map                                                                                                                         |
