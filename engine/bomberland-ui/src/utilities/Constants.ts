...
export abstract class Constants {
    ...
    public static readonly Home = "https://www.coderone.dev";
    public static readonly ReportBugEmail = "mailto:humans@coderone.dev?subject=Reporting a bug/issue with Coder One";
