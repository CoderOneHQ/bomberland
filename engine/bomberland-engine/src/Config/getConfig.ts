...
export const getConfig = (override?: Partial<IConfig>, shouldLogEnv: boolean = false): IConfig => {
    return {
        ...
        AmmunitionDurationTicks: getIntFromEnv(shouldLogEnv, "AMMO_DURATION_TICKS", 40),
        AmmunitionSpawnWeighting: getFloatFromEnv(shouldLogEnv, "AMMO_SPAWN_WEIGHTING", 0.0),
        BlastDurationTicks: getIntFromEnv(shouldLogEnv, "BLAST_DURATION_TICKS", 5),
        BlastPowerupDurationTicks: getIntFromEnv(shouldLogEnv, "BLAST_POWERUP_DURATION_TICKS", 40),
        BlastPowerupSpawnWeighting: getFloatFromEnv(shouldLogEnv, "BLAST_POWERUP_SPAWN_WEIGHTING", 0.5),
        BombArmedTicks: getIntFromEnv(shouldLogEnv, "BOMB_ARMED_TICKS", 5),
        BombDurationTicks: getIntFromEnv(shouldLogEnv, "BOMB_DURATION_TICKS", 30),
        EntitySpawnProbabilityPerTick: getFloatFromEnv(shouldLogEnv, "ENTITY_SPAWN_PROBABILITY_PER_TICK", 0),
        FireSpawnIntervalTicks: getFloatFromEnv(shouldLogEnv, "FIRE_SPAWN_INTERVAL_TICKS", 2),
        FreezeDebuffDurationTicks: getFloatFromEnv(shouldLogEnv, "FREEZE_DEBUFF_DURATION_TICKS", 15),
        FreezePowerupDurationTicks: getFloatFromEnv(shouldLogEnv, "FREEZE_POWERUP_DURATION_TICKS", 40),
        FreezePowerupSpawnWeighting: getFloatFromEnv(shouldLogEnv, "FREEZE_POWERUP_SPAWN_WEIGHTING", 0.5),
        GameDurationTicks: getIntFromEnv(shouldLogEnv, "GAME_DURATION_TICKS", 200),
        GameStartDelayMs: getIntFromEnv(shouldLogEnv, "GAME_START_DELAY_MS", 2000),
        HookAuthToken: process.env.HOOK_AUTH_TOKEN,
        InitialAmmunition: getIntFromEnv(shouldLogEnv, "INITIAL_AMMUNITION", 9999),
        ...
        ObjectDestructionItemDropProbability: getFloatFromEnv(shouldLogEnv, "OBJECT_DESTRUCTION_ITEM_DROP_PROBABILITY", 0.5),
        ...
        SteelBlockFrequency: getFloatFromEnv(shouldLogEnv, "STEEL_BLOCK_FREQUENCY", 0.1222222222222222),
        ...
        WoodBlockFrequency: getFloatFromEnv(shouldLogEnv, "WOOD_BLOCK_FREQUENCY", 0.1969135802469136),
