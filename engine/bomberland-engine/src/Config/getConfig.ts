...
export const getConfig = (override?: Partial<IConfig>, shouldLogEnv: boolean = false): IConfig => {
    return {
        ...
        AmmoSpawnWeighting: getFloatFromEnv(shouldLogEnv, "AMMO_SPAWN_WEIGHTING", 0.0),
        ...
        BlastPowerupSpawnWeighting: getFloatFromEnv(shouldLogEnv, "BLAST_POWERUP_SPAWN_WEIGHTING", 0.0),
        ...
        FreezeDebuffDurationTicks: getFloatFromEnv(shouldLogEnv, "FREEZE_DEBUFF_DURATION_TICKS", 20),
        FreezePowerupDurationTicks: getFloatFromEnv(shouldLogEnv, "FREEZE_POWERUP_DURATION_TICKS", 2),
        FreezePowerupSpawnWeighting: getFloatFromEnv(shouldLogEnv, "FREEZE_POWERUP_SPAWN_WEIGHTING", 1.0),
