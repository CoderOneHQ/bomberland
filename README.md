...
[Bomberland](https://www.coderone.dev/bomberland) is a multi-agent AI competition inspired by the classic console game Bomberman.
...
See: [Documentation](https://www.coderone.dev/docs)
